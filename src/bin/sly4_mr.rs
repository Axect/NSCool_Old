...
pub const RHO0: f64 = -6.4;
pub const RHO1: f64 = -5.6;
pub const RHO2: f64 = -3.6;
...
fn main() {
    ...
    let fps_data = Matrix::read("data/sly4.dat", false, ' ').expect("Can't read SLy4");
...
//    let GAMMA4 = param[4];
    ...
    let results = (0..SIZE).into_par_iter().map(|idx| {
        ...
        let rho_c = convert(6.749E+15f64 + (idx as f64) * (1e+13 - 6e+15) / 1000f64, Density, cgs_to_geom);
