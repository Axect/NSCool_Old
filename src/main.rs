...
pub const K2: f64 = 0.4424f64;
pub const GAMMA2: f64 = 1.3841f64;
...
fn main() {
    ...
    python! {
        ...
        plt.grid()
        plt.savefig("figure/APR/r_vs_rho.png")
        ...
        plt.grid()
        plt.savefig("figure/APR/r_vs_m.png")
        ...
        plt.grid()
        plt.savefig("figure/APR/r_vs_p.png")
    }
}
